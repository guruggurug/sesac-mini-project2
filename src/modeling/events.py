...
def analyze_single_event_reaction(
    ...
    event_date_str = str(event.get("market_event_date", ""))
    ...
    return {
        ...
        "market_event_date": str(event.get("market_event_date", "")),
...
def analyze_all_events(
    ...
    """
    Run post-event reaction analysis for approved events of valid status.
    """
    ...
    # Filter events: review_status == approved
